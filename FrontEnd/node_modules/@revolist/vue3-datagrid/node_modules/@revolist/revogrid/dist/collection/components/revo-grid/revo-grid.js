...
export class RevoGridComponent {
  ...
  render() {
    ...
    return (h(Host, Object.assign({}, { [`${UUID}`]: this.uuid }),
      h(RevoViewPort, { viewports: this.viewportProvider.stores, dimensions: this.dimensionProvider.stores, orderRef: e => (this.orderService = e), registerElement: (e, k) => this.scrollingService.registerElement(e, k), nakedClick: () => this.viewport.clearEdit(), onScroll: details => this.scrollingService.onScroll(details) },
        this.rowHeaders ? (h(RevogrRowHeaders, { height: contentHeight, anyView: this.viewport.columns[0], resize: this.resize, rowHeaderColumn: typeof this.rowHeaders === 'object' ? this.rowHeaders : undefined, beforeRowAdd: y => this.selectionStoreConnector.registerRow(y), onScrollViewport: e => this.scrollingService.onScroll(e, 'headerRow'), onElementToScroll: e => this.scrollingService.registerElement(e, 'headerRow') })) : (''),
        h(ViewPortSections, { columnFilter: !!this.filter, resize: this.resize, readonly: this.readonly, range: this.range, rowClass: this.rowClass, editors: this.editors, useClipboard: this.useClipboard, columns: this.viewport.columns, onEdit: detail => {
  ...
  static get properties() { return {
    ...
    "filter": {
      ...
      "complexType": {
        ...
        "resolved": "boolean | { collection?: Record<ColumnProp, FilterCollectionItem>; include?: string[]; customFilters?: Record<string, CustomFilter>; }",
        "references": {
          "ColumnFilterConfig": {
            "location": "import",
  ...
  static get events() { return [{
      ...
      "complexType": {
        ...
        "resolved": "{ columns: Record<DimensionCols, ColumnRegular[]>; columnGrouping: Record<DimensionCols, Group[]>; maxLevel: number; sort: Record<ColumnProp, ColumnRegular>; }",
        "references": {
          "ColumnCollection": {
            "location": "import",
  ...
  static get methods() { return {
    ...
    "getSourceStore": {
      "complexType": {
        ...
        "return": "Promise<Observable<DataSourceState<DataType, DimensionRows>>>"
      },
      "docs": {
    ...
    "getColumnStore": {
      "complexType": {
        ...
        "return": "Promise<Observable<DataSourceState<ColumnRegular, DimensionCols>>>"
      },
      "docs": {
