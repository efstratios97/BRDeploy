...
const index = require('./index-439328ab.js');
const filter_button = require('./filter.button-fd010324.js');
  ...
  getViewportColumnData(contentHeight) {
    ...
    columnTypes.forEach(val => {
      ...
      const column = {
        ...
        colStore,
        onHeaderResize: (e) => { var _a; return (_a = this.sv.dimensionProvider) === null || _a === void 0 ? void 0 : _a.setDimensionSize(val, e.detail); },
      };
      if (val === 'rgCol') {
...
const RevogrRowHeaders = ({ anyView, height, rowHeaderColumn, beforeRowAdd, onScrollViewport, onElementToScroll }) => {
  ...
  return (index.h("revogr-viewport-scroll", Object.assign({}, { [UUID]: parent }, { contentHeight: height, contentWidth: 0, class: "rowHeaders", key: "rowHeaders", style: { minWidth: `${colSize}px` }, ref: el => onElementToScroll(el), onScrollViewport: e => onScrollViewport(e.detail) }),
    index.h("revogr-header", Object.assign({}, Object.assign(Object.assign({}, anyView.headerProp), { colData: typeof rowHeaderColumn === 'object' ? [rowHeaderColumn] : [] }), { viewportCol: viewport.store, parent: parent, slot: "header", canResize: false })),
    dataViews));
};
...
const RevoGridComponent = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, { [`${UUID}`]: this.uuid }), index.h(RevoViewPort, { viewports: this.viewportProvider.stores, dimensions: this.dimensionProvider.stores, orderRef: e => (this.orderService = e), registerElement: (e, k) => this.scrollingService.registerElement(e, k), nakedClick: () => this.viewport.clearEdit(), onScroll: details => this.scrollingService.onScroll(details) }, this.rowHeaders ? (index.h(RevogrRowHeaders, { height: contentHeight, anyView: this.viewport.columns[0], resize: this.resize, rowHeaderColumn: typeof this.rowHeaders === 'object' ? this.rowHeaders : undefined, beforeRowAdd: y => this.selectionStoreConnector.registerRow(y), onScrollViewport: e => this.scrollingService.onScroll(e, 'headerRow'), onElementToScroll: e => this.scrollingService.registerElement(e, 'headerRow') })) : (''), index.h(ViewPortSections, { columnFilter: !!this.filter, resize: this.resize, readonly: this.readonly, range: this.range, rowClass: this.rowClass, editors: this.editors, useClipboard: this.useClipboard, columns: this.viewport.columns, onEdit: detail => {
