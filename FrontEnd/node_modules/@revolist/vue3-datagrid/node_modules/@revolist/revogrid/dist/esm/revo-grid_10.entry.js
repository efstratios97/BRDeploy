import { g as getRenderingRef, f as forceUpdate, h, r as registerInstance, c as createEvent, H as Host, e as getElement } from './index-a228de17.js';
import { i as isFilterBtn, F as FILTER_PROP, a as FilterButton } from './filter.button-63167c46.js';
...
const RevoGridComponent = class {
  ...
  render() {
    ...
    return (h(Host, Object.assign({}, { [`${UUID}`]: this.uuid }), h(RevoViewPort, { viewports: this.viewportProvider.stores, dimensions: this.dimensionProvider.stores, orderRef: e => (this.orderService = e), registerElement: (e, k) => this.scrollingService.registerElement(e, k), nakedClick: () => this.viewport.clearEdit(), onScroll: details => this.scrollingService.onScroll(details) }, this.rowHeaders ? (h(RevogrRowHeaders, { height: contentHeight, anyView: this.viewport.columns[0], resize: this.resize, rowHeaderColumn: typeof this.rowHeaders === 'object' ? this.rowHeaders : undefined, beforeRowAdd: y => this.selectionStoreConnector.registerRow(y), onScrollViewport: e => this.scrollingService.onScroll(e, 'headerRow'), onElementToScroll: e => this.scrollingService.registerElement(e, 'headerRow') })) : (''), h(ViewPortSections, { columnFilter: !!this.filter, resize: this.resize, readonly: this.readonly, range: this.range, rowClass: this.rowClass, editors: this.editors, useClipboard: this.useClipboard, columns: this.viewport.columns, onEdit: detail => {
